    ...
    <div className="space-y-8">
      ...
      <div className="glass-card p-4 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex items-center gap-2 px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-medium text-slate-500 hover:bg-slate-100 transition-all">
            <Filter className="w-4 h-4" />
            Filter
          </button>
          <select className="bg-slate-50 border border-slate-100 rounded-xl px-4 py-2.5 text-sm font-medium text-slate-500 focus:outline-none focus:border-blue-500/50">
